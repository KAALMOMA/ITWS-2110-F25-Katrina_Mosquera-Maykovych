...
// Put the code for Part 2 here  \/
    ...
    /* Yes, there is a way to achieve this same result without ifs.
     *
     * We could instead use a SWITCH STATEMENT, which allows us to compare
     * the same variable with many different values, and execute different code
     * depending on which value it is equal to.
     * 
     * In this case, we are comparing the value stored in $_POST to 4 different
     * possible values: 'add', 'sub', 'mult', and 'div'.
     * 
     * For each of these four possible values, we execute a different block
     * of code. Each block instantiates a new object corresponding to the 
     * given operation and 2 provided operands.
     * 
     * The switch statement for this situation would be written as follows:
     * 
     * if (isset($_POST['add'])) {
     *   $option = 'Add';
     * if (isset($_POST['sub'])) {
